...
public class Day01_2 { // c s
	...
	// console( ctrl + F11 )에 원하는 대로 출력할 수 있다.
	...
	public static void main(String[] args) { // ms
		...
		System.out.print(123);	// 숫자 " " 처리 안함
			// * 미리 만들어진 단어[ 예약어 ]를 제외한 모든 문자는 " " 처리
		
		// 2. 자동완성 ( syso + ctrl + space )
		System.out.println("할말");
		System.out.println("자바칩 프라푸치노");
		...
		System.out.println("강호동\t출석\t결석\t결석\t출석");
		System.out.println("유재석\t출석\t출석\t출석\t출석\t개근");
		System.out.println("-------------------------------------------");
		
		// 예제2 [ 예제1 -> printf ]
		System.out.printf("\n\t\t%s","[[출석부]]\n");
		System.out.printf("-------------------------------------------\n");
		System.out.printf("%s\t%s\t%s\t%s\t%s\t%s \n","이름","1교시","2교시","3교시","4교시","비고");
		System.out.printf("%s\t%s\t%s\t%s\t%s\t%s \n","강호동","출석","결석","결석","출석"," ");
		System.out.printf("%s\t%s\t%s\t%s\t%s\t%s \n","유재석","출석","출석","출석","출석","개근");
		System.out.printf("-------------------------------------------\n");
