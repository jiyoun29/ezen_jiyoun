...
public class Day02_2 { // cs
	...
	public static void main(String[] args) { // ms
		...
		// 진법 [왜? -> 컴퓨터가 2진수만 사용하면 표현할 수 있는 단위가 적음 -> 표현단위 다양성]
		...
		long num5 = 1000000000000L; System.out.println(num5);
			// int형 -> long형
		...
		double num8 = 0.1234567891234567891111111111; System.out.println(num8);
		float num9 = 0.1234567891234567891111111111f; System.out.println(num9);
		...
		// p.49 : 타입변환
			...
			// 1. 자동 형변환
				// 작은 상자에서 큰 상자로 이동 가능
				// 큰 상자에서 작은 상자로 이동 불가능
		byte 바이트 = 10;
		int  인트 = 바이트; // 자동 형변환
		// short 쇼트 = 인트; // 자동 형변환x 오류 발생
