...
public class Day02_4 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 5. 증감 [ * : 일정 간격으로 변화 ]
		 * 	// 1. ++ : 1증가 2. -- : 1감소 ( ex : 엘리베이터 등)
		 * 		// 선위 증가 : 우선 증가. 먼저 증가하고 다른 명령어 처리
		 * 		// 후위 증가 : 다른 명령어 처리 후에 증가
		 * 
		 * 6. 상황연산자[조건연산자]
		 * 		조건식, ?, 참, 거짓.
		 * 
		...
		System.out.println("후위감소 : " + 정수1--); // 출력 후 1감소-> 11
		...
		// 대입연산자 예제
		정수1 = 정수1 + 10;	System.out.println("정수1 : " + 정수1); // 20
		정수1 += 10; System.out.println("정수1 : " + 정수1); // 위 코드에 합쳐진 값 30
		...
		char 등급 = 정수 > 90 ? 'A' : 'B';
			// 조건식 ? 참(true) : 거짓(false) **
			// 점수변수가 90 초과하면 A 대입 아니면 B
		System.out.println("등급 : " + 등급);
		char 등급2 = 정수 > 90 ? 'A' : 정수 > 80 ? 'B' : 'C' ;
			// 조건식 ? 참 : 거짓[ 조건식 ? 참 : 거짓 ]
			// 점수변수가 90 초과하면 A, 80 초과하면 B, 아니면 C
		System.out.println("등급2 : " + 등급2);
