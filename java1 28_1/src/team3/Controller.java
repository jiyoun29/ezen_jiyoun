...
public class Controller {
	...
	public static int 예약(String 날짜, String name, int ch) {
		...
		for(int i = 0; i<호텔예매.roomlist.length; i++) {
			if(호텔예매.roomlist[i]==null) {
					if(ch==1) {	호텔예매.roomlist[i]=room1;
						return 1; } // if e
					else if(ch==2) { 호텔예매.roomlist[i]=room2;
						return 2; } // else if e
					else if(ch==3) { 호텔예매.roomlist[i]=room3;
						return 3; } // else if e
					else if(ch==4) { 호텔예매.roomlist[i]=room4;
						return 4; } // else if e
					else if(ch==5) { 호텔예매.roomlist[i]=room5;
						return 5; } // else if e
					} // if e
				} // for e	
			return 6; } // 예약 e
	...
	public static void 취소 (String id) {
